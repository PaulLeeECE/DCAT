...
img_path = "/mnt/data0/aimm_lynn/group_affect/datasets/GroupEmoW/GroupEmoW_Train/Positive/"
saveDir = './data/GroupEmoW_process/GroupEmoW_Train/Positive/'           # the directory that save your preprocess data
index_path = './data/GroupEmoW_process/GroupEmoW_Train/Pos_index.npy'    # the path that save your preprocess data's index
