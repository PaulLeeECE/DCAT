...
def extract_feature():
    ...
    resultDir = args.result_dir + '/' + Class1
    ...
    for i in range(len(uni_ImgId)):
        ...
        test_result = Class1 + "Picture_" + str(int(uni_ImgId[i])).zfill(5)+".jpg"+' '+ str(np.argmax(hat_label, axis=0))
        ...
        while True:
            if int(index_test_set[k]) == int(uni_ImgId[i]):
                f.write(test_result+'\n')
                resultFile.write(Class1 + "Picture_" + str(int(uni_ImgId[i])).zfill(5)+".jpg"+","+string+'\n')
                k = k + 1
                break
            else:
                result_temp = Class1 + "Picture_" + str(int(index_test_set[k])).zfill(5)+".jpg"+' '+ "-1"
                f.write(result_temp+'\n')
                resultFile.write(Class1 + "Picture_" + str(int(index_test_set[k])).zfill(5)+".jpg"+'\n')
                k = k + 1
